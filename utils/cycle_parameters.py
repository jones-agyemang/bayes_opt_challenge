...
CYCLE_FUNCTION_OVERRIDES = {
    ...
    11: {
        ...
        7: build_hebo_override(
            surrogate_updates={
                "kernel": {"type": "linear_plus_matern32", "length_scale": 0.23},
                "stochastic_mean_xi": 1.23,
                "warp_multistarts": 8,
                "warp_maxiter": 50,
                "gp_restarts": 15,
            },
        ...
        8: build_hebo_override(
            surrogate_updates={
                "kernel": {"type": "linear_plus_matern52", "length_scale": 0.1},
                "stochastic_mean_xi": 1.0,
                "warp_multistarts": 6,
                "warp_maxiter": 40,
                "gp_restarts": 12,
    ...
    12: {
        ...
        3: build_hebo_override(
            surrogate_updates={
                "kernel": {"type": "linear_plus_matern32", "length_scale": 0.45},
                "stochastic_mean_xi": 1.5,
                "warp_multistarts": 80,
                "warp_maxiter": 500,
                "gp_restarts": 150,
        ...
        4: build_hebo_override(
            surrogate_updates={
                "kernel": {"type": "matern52", "length_scale": 0.25},
                "stochastic_mean_xi": 0.75,
                "warp_multistarts": 40,
                "warp_maxiter": 300,
                "gp_restarts": 100,
        ...
        5: build_hebo_override(
            surrogate_updates={
                "kernel": {"type": "linear_plus_matern52", "length_scale": 1.05},
                "stochastic_mean_xi": 0.75,
                "warp_multistarts": 60,
                "warp_maxiter": 400,
                "gp_restarts": 120,
        ...
        6: build_hebo_override(
            surrogate_updates={
                "kernel": {"type": "matern32", "length_scale": 1.25},
                "stochastic_mean_xi": 1.25,
                "warp_multistarts": 60,
                "warp_maxiter": 500,
                "gp_restarts": 150,
        ...
        7: build_hebo_override(
            surrogate_updates={
                "kernel": {"type": "linear_plus_matern32", "length_scale": 1.23},
                "stochastic_mean_xi": 1.23,
                "warp_multistarts": 80,
                "warp_maxiter": 500,
                "gp_restarts": 150,
        ...
        8: build_hebo_override(
            surrogate_updates={
                "kernel": {"type": "linear_plus_matern52", "length_scale": 0.14},
                "stochastic_mean_xi": 1.0,
                "warp_multistarts": 60,
                "warp_maxiter": 400,
                "gp_restarts": 120,
